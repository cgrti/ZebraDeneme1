...
void setup_scr_screen_14(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_14, 800, 480);
    ...
    //Write codes screen_14_img_1
    ui->screen_14_img_1 = lv_image_create(ui->screen_14);
    lv_obj_set_pos(ui->screen_14_img_1, 0, 0);
    lv_obj_set_size(ui->screen_14_img_1, 800, 480);
    lv_obj_add_flag(ui->screen_14_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_14_img_1, &_15_sarj_ozeti_ac_5_RGB565A8_800x480);
    lv_image_set_pivot(ui->screen_14_img_1, 50,50);
    lv_image_set_rotation(ui->screen_14_img_1, 0);

    //Write style for screen_14_img_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_14_img_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_14_img_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_14_btn_4
    ui->screen_14_btn_4 = lv_button_create(ui->screen_14);
    lv_obj_set_pos(ui->screen_14_btn_4, 215, 400);
    lv_obj_set_size(ui->screen_14_btn_4, 49, 48);
    ui->screen_14_btn_4_label = lv_label_create(ui->screen_14_btn_4);
    lv_label_set_text(ui->screen_14_btn_4_label, "");
    ...
    lv_obj_set_style_bg_opa(ui->screen_14_btn_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_14_btn_3 = lv_button_create(ui->screen_14);
    lv_obj_set_pos(ui->screen_14_btn_3, 154, 400);
    lv_obj_set_size(ui->screen_14_btn_3, 49, 48);
    ui->screen_14_btn_3_label = lv_label_create(ui->screen_14_btn_3);
    lv_label_set_text(ui->screen_14_btn_3_label, "");
    ...
    lv_obj_set_style_bg_opa(ui->screen_14_btn_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_14_btn_2 = lv_button_create(ui->screen_14);
    lv_obj_set_pos(ui->screen_14_btn_2, 32, 400);
    lv_obj_set_size(ui->screen_14_btn_2, 49, 48);
    ui->screen_14_btn_2_label = lv_label_create(ui->screen_14_btn_2);
    lv_label_set_text(ui->screen_14_btn_2_label, "");
    ...
    ui->screen_14_btn_1 = lv_button_create(ui->screen_14);
    lv_obj_set_pos(ui->screen_14_btn_1, 94, 400);
    lv_obj_set_size(ui->screen_14_btn_1, 49, 48);
    ui->screen_14_btn_1_label = lv_label_create(ui->screen_14_btn_1);
    lv_label_set_text(ui->screen_14_btn_1_label, "");
    ...
    ui->screen_14_btn_5 = lv_button_create(ui->screen_14);
    lv_obj_set_pos(ui->screen_14_btn_5, 32, 116);
    lv_obj_set_size(ui->screen_14_btn_5, 49, 48);
    ui->screen_14_btn_5_label = lv_label_create(ui->screen_14_btn_5);
    lv_label_set_text(ui->screen_14_btn_5_label, "");
    ...
    lv_obj_set_style_bg_opa(ui->screen_14_btn_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
