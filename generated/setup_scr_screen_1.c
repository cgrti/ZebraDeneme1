...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_1_img_1, 800, 480);
    lv_obj_add_flag(ui->screen_1_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_1_img_1, &_2_anasayfa_ac_5_RGB565A8_800x480);
    ...
    lv_obj_set_pos(ui->screen_1_btn_1, 285, 400);
    lv_obj_set_size(ui->screen_1_btn_1, 230, 44);
    ...
    lv_obj_set_pos(ui->screen_1_btn_2, 52, 132);
    lv_obj_set_size(ui->screen_1_btn_2, 188, 219);
    ...
    lv_obj_set_pos(ui->screen_1_btn_3, 308, 132);
    lv_obj_set_size(ui->screen_1_btn_3, 188, 219);
    ...
    lv_obj_set_pos(ui->screen_1_btn_4, 560, 132);
    lv_obj_set_size(ui->screen_1_btn_4, 188, 219);
    ...
    lv_obj_set_pos(ui->screen_1_btn_5, 32, 400);
    lv_obj_set_size(ui->screen_1_btn_5, 49, 48);
    ...
    lv_obj_set_style_bg_opa(ui->screen_1_btn_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_1_btn_6 = lv_button_create(ui->screen_1);
    lv_obj_set_pos(ui->screen_1_btn_6, 94, 400);
    lv_obj_set_size(ui->screen_1_btn_6, 49, 48);
    ...
    lv_obj_set_style_bg_opa(ui->screen_1_btn_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_1_btn_7 = lv_button_create(ui->screen_1);
    lv_obj_set_pos(ui->screen_1_btn_7, 154, 400);
    lv_obj_set_size(ui->screen_1_btn_7, 49, 48);
    ...
    lv_obj_set_style_bg_opa(ui->screen_1_btn_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_1_btn_8 = lv_button_create(ui->screen_1);
    lv_obj_set_pos(ui->screen_1_btn_8, 215, 400);
    lv_obj_set_size(ui->screen_1_btn_8, 49, 48);
    ...
    lv_obj_set_style_bg_opa(ui->screen_1_btn_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_1_btn_9 = lv_button_create(ui->screen_1);
    lv_obj_set_pos(ui->screen_1_btn_9, 11, 31);
    lv_obj_set_size(ui->screen_1_btn_9, 775, 53);
    ...
    lv_obj_set_style_bg_opa(ui->screen_1_btn_9, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
