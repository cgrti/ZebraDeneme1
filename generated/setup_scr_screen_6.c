...
void setup_scr_screen_6(lv_ui *ui)
{
    ...
    lv_image_set_src(ui->screen_6_img_1, &_7_haberlesme_ac_5_RGB565A8_800x480);
    ...
    lv_obj_set_pos(ui->screen_6_btn_1, 307, 113);
    lv_obj_set_size(ui->screen_6_btn_1, 188, 246);
