...
void setup_scr_screen_3(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_3_img_1, 800, 480);
    lv_obj_add_flag(ui->screen_3_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_3_img_1, &_4_qrkod_ac_5_RGB565A8_800x480);
    ...
    lv_obj_set_pos(ui->screen_3_btn_4, 215, 400);
    lv_obj_set_size(ui->screen_3_btn_4, 49, 48);
    ...
    lv_obj_set_pos(ui->screen_3_btn_3, 154, 400);
    lv_obj_set_size(ui->screen_3_btn_3, 49, 48);
    ...
    lv_obj_set_pos(ui->screen_3_btn_2, 32, 400);
    lv_obj_set_size(ui->screen_3_btn_2, 49, 48);
    ...
    lv_obj_set_style_bg_opa(ui->screen_3_btn_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_3_btn_1, 94, 400);
    lv_obj_set_size(ui->screen_3_btn_1, 49, 48);
    ...
    lv_obj_set_style_bg_opa(ui->screen_3_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
