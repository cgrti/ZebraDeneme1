...
void setup_scr_screen_4(lv_ui *ui)
{
    ...
    ui->screen_4_img_1 = lv_image_create(ui->screen_4);
    lv_obj_set_pos(ui->screen_4_img_1, 0, 0);
    lv_obj_set_size(ui->screen_4_img_1, 800, 480);
    lv_obj_add_flag(ui->screen_4_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_4_img_1, &_5_oyelik_detay_ac_5_RGB565A8_800x480);
    ...
    ui->screen_4_btn_4 = lv_button_create(ui->screen_4);
    lv_obj_set_pos(ui->screen_4_btn_4, 215, 400);
    lv_obj_set_size(ui->screen_4_btn_4, 49, 48);
    ...
    lv_obj_set_style_bg_opa(ui->screen_4_btn_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_4_btn_3 = lv_button_create(ui->screen_4);
    lv_obj_set_pos(ui->screen_4_btn_3, 154, 400);
    lv_obj_set_size(ui->screen_4_btn_3, 49, 48);
    ...
    lv_obj_set_style_bg_opa(ui->screen_4_btn_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_4_btn_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_4_btn_3, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_4_btn_2 = lv_button_create(ui->screen_4);
    lv_obj_set_pos(ui->screen_4_btn_2, 32, 400);
    lv_obj_set_size(ui->screen_4_btn_2, 49, 48);
    ...
    lv_obj_set_style_bg_opa(ui->screen_4_btn_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_4_btn_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_4_btn_2, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_4_btn_1, 94, 400);
    lv_obj_set_size(ui->screen_4_btn_1, 49, 48);
