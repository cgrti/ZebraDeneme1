...
void setup_scr_screen_8(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_8, 800, 480);
    ...
    lv_obj_set_pos(ui->screen_8_img_1, 0, 0);
    lv_obj_set_size(ui->screen_8_img_1, 800, 480);
    lv_obj_add_flag(ui->screen_8_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_8_img_1, &_9_sarj_ana_ekran_beklemede_ac_5_RGB565A8_800x480);
    ...
    ui->screen_8_btn_4 = lv_button_create(ui->screen_8);
    lv_obj_set_pos(ui->screen_8_btn_4, 215, 400);
    lv_obj_set_size(ui->screen_8_btn_4, 49, 48);
    ...
    lv_obj_set_style_bg_opa(ui->screen_8_btn_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_8_btn_4, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_8_btn_3 = lv_button_create(ui->screen_8);
    lv_obj_set_pos(ui->screen_8_btn_3, 154, 400);
    lv_obj_set_size(ui->screen_8_btn_3, 49, 48);
    ui->screen_8_btn_3_label = lv_label_create(ui->screen_8_btn_3);
    lv_label_set_text(ui->screen_8_btn_3_label, "");
    ...
    lv_obj_set_style_bg_opa(ui->screen_8_btn_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_8_btn_2 = lv_button_create(ui->screen_8);
    lv_obj_set_pos(ui->screen_8_btn_2, 32, 400);
    lv_obj_set_size(ui->screen_8_btn_2, 49, 48);
    ui->screen_8_btn_2_label = lv_label_create(ui->screen_8_btn_2);
    lv_label_set_text(ui->screen_8_btn_2_label, "");
    ...
    lv_obj_set_pos(ui->screen_8_btn_1, 94, 400);
    lv_obj_set_size(ui->screen_8_btn_1, 49, 48);
    ui->screen_8_btn_1_label = lv_label_create(ui->screen_8_btn_1);
    lv_label_set_text(ui->screen_8_btn_1_label, "");
    ...
    //Write codes screen_8_btn_5
    ui->screen_8_btn_5 = lv_button_create(ui->screen_8);
    lv_obj_set_pos(ui->screen_8_btn_5, 285, 400);
    lv_obj_set_size(ui->screen_8_btn_5, 229, 48);
    ui->screen_8_btn_5_label = lv_label_create(ui->screen_8_btn_5);
    lv_label_set_text(ui->screen_8_btn_5_label, "");
    lv_label_set_long_mode(ui->screen_8_btn_5_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_8_btn_5_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_8_btn_5, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_8_btn_5_label, LV_PCT(100));

    //Write style for screen_8_btn_5, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_8_btn_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_8_btn_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_8_btn_5, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_8_btn_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_8_btn_5, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_8_btn_5, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_8_btn_5, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_8_btn_5, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
