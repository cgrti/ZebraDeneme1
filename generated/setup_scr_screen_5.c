...
void setup_scr_screen_5(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_5_img_1, 0, 0);
    lv_obj_set_size(ui->screen_5_img_1, 800, 480);
    lv_obj_add_flag(ui->screen_5_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_5_img_1, &_6_arac_baglantisi_ac_5_RGB565A8_800x480);
    ...
    ui->screen_5_btn_4 = lv_button_create(ui->screen_5);
    lv_obj_set_pos(ui->screen_5_btn_4, 215, 400);
    lv_obj_set_size(ui->screen_5_btn_4, 49, 48);
    ...
    lv_obj_set_style_bg_opa(ui->screen_5_btn_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_5_btn_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_5_btn_4, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_5_btn_4, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_5_btn_3 = lv_button_create(ui->screen_5);
    lv_obj_set_pos(ui->screen_5_btn_3, 154, 400);
    lv_obj_set_size(ui->screen_5_btn_3, 49, 48);
    ui->screen_5_btn_3_label = lv_label_create(ui->screen_5_btn_3);
    lv_label_set_text(ui->screen_5_btn_3_label, "");
    ...
    lv_obj_set_style_bg_opa(ui->screen_5_btn_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_5_btn_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_5_btn_3, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_5_btn_3, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_5_btn_2 = lv_button_create(ui->screen_5);
    lv_obj_set_pos(ui->screen_5_btn_2, 32, 400);
    lv_obj_set_size(ui->screen_5_btn_2, 49, 48);
    ui->screen_5_btn_2_label = lv_label_create(ui->screen_5_btn_2);
    lv_label_set_text(ui->screen_5_btn_2_label, "");
    lv_label_set_long_mode(ui->screen_5_btn_2_label, LV_LABEL_LONG_WRAP);
    ...
    lv_obj_set_style_bg_opa(ui->screen_5_btn_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_5_btn_2, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_5_btn_1, 94, 400);
    lv_obj_set_size(ui->screen_5_btn_1, 49, 48);
    ...
    ui->screen_5_btn_5 = lv_button_create(ui->screen_5);
    lv_obj_set_pos(ui->screen_5_btn_5, 203, 127);
    lv_obj_set_size(ui->screen_5_btn_5, 389, 219);
    ui->screen_5_btn_5_label = lv_label_create(ui->screen_5_btn_5);
    lv_label_set_text(ui->screen_5_btn_5_label, "");
    lv_label_set_long_mode(ui->screen_5_btn_5_label, LV_LABEL_LONG_WRAP);
    ...
    lv_obj_set_style_bg_opa(ui->screen_5_btn_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_5_btn_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_5_btn_5, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_5_btn_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_5_btn_5, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_5_btn_5, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
